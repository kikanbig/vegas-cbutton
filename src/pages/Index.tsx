...
const steps = [
  ...
  },
  {
    ...
    text: "Сразу после нажатия отмечаете, чем закончился разговор: продажа, КП или отказ.",
  },
];
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  text: "Сразу отметьте результат: продажа, отправили КП или гость отказался. Так воронка становится честной.",
                },
              ].map((item) => (
